...
\title{Exercise Class Solutions 4}
\date{}
\author{}
\maketitle
...
\chapter{13}{Modeling Computation}
	\subchapter{3}{Finite-State Machines with no Output}
		\subfile{problems/13.3.49.tex}
		\pagebreak
	\subchapter{4}{Language Recognition}
		\subfile{problems/13.4.1bdf.tex}
		\pagebreak
		\subfile{problems/13.4.5abcde.tex}
		\pagebreak
		\subfile{problems/13.4.7abcd.tex}
		\pagebreak
		\subfile{problems/13.4.14ac.tex}
		\pagebreak
		\subfile{problems/13.4.17.tex}
		\pagebreak
...
\section*{Additional Exercises}
	\subsection*{}
		...
		\pagebreak
		\subfile{problems/additional_exercise_2.tex}
